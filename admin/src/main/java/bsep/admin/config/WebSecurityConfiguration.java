...
import bsep.admin.security.auth.RestAuthenticationEntryPoint;
import bsep.admin.security.auth.TokenAuthenticationFilter;
import bsep.admin.service.CustomUserDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests().antMatchers("/auth/**","/certificate-request/**").permitAll()
